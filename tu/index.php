...
<body>
  ...
  ?>
          ...
          <div class="col-lg-8 offset-lg-2">
            <div class="h_blog_text" id="syarat">
              <div class="h_blog_text_inner left right pb-3 pb-extra">
                ...
                <h4>Upload Rapor Siswa</h4>
                <div class="row">
                  <div class="col-12">
                    <label for="nis">NIS</label>
                  </div>
                  <div class="col-9">
                    <input required type="text" name="nis" id="nis" class="col">
                  </div>
                  <div class="col-3">
                    <button class="submit-btn find-btn" id="cari">CARI</button>
                  </div>
                </div>
                <div class="row">
                  <div class="col-12">
                  ...
                  <div class="col-12">
                    <input required readonly type="text" name="nama" id="nama" class="col">
                  </div>
                </div>
                <div class="row">
                  <div class="col-12">
                  ...
                  <div class="col-12">
                    <input required readonly type="text" name="kelas" id="kelas" class="col">
                  </div>
                </div>
                <div class="row">
                  <div class="col-12">
                  ...
                  <div class="col-12">
                    <select name="spp" id="spp" class="col">
                ...
                <div class="row">
                  ...
                  <input required type="file" name="file" id="rapor" class="col-12" accept=".pdf">
                </div>
                <div class="mt-extra d-flex">
                  <a href="summary.php">Lihat keseluruhan</a>
                  <input type="submit" value="UPLOAD" class="submit-btn ml-auto" name="submit">
                </div>

                <br>
                <hr><br>
                <h4>Update Status SPP Siswa</h4>
                <div class="row">
                  <div class="col-12">
                    <label for="nis-update">NIS</label>
                  </div>
                  <div class="col-9">
                    <input type="text" name="nis-update" id="nis-update" class="col">
                  </div>
                  <div class="col-3">
                    <button class="submit-btn find-btn" id="cari-update">CARI</button>
                  </div>
                </div>
                <div class="row">
                  <div class="col-12">
                  ...
                  <div class="col-12">
                    <input required readonly type="text" name="nama-update" id="nama-update" class="col">
                  </div>
                </div>
                <div class="row">
                  <div class="col-12">
                    <label for="spp-update">SPP</label>
                  </div>
                  <div class="col-12">
                    <select name="spp-update" id="spp-update" class="col">
                      <option value="lunas">Lunas</option>
                      <option value="menunggak">Menunggak</option>
                    </select>
                  </div>
                ...
                <div class="mt-extra d-flex">
                  <button class="submit-btn ml-auto" id="updateSpp">UPDATE</button>
                </div>
              </div>
            </div>
          </div>
    ...
    <script>
      ...
      const cariUpdate = document.querySelector("#cari-update");
      const updateBtn = document.querySelector("#updateSpp");
      ...
      cariUpdate.addEventListener("click", (event) => {
        let nis = document.getElementById("nis-update").value;
        fetch("datasiswa.php?nis=" + nis).then((Response) => {
          Response.json().then((json) => {
            console.log(json);
            let nama = json.nama;
      ...
      updateBtn.addEventListener("click", (Event) => {
        let nis = document.getElementById("nis-update");
        if (nis.value.trim() != "") {


          let nama = document.getElementById("nama-update");
          let status = document.getElementById("spp-update");
          let fstatus;
